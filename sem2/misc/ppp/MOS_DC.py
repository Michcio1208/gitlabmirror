...
# ==========================================
# Figura 1: DC Zadanie 4 (Wpływ różnych parametrów na NMOS-D)
# ==========================================
fig1, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(18, 5))
fig1.suptitle('DC Zadanie 4: Tranzystor NMOS z kanałem zubożanym (D-MOS)', fontsize=15, fontweight='bold')
...
# ==========================================
# Figura 2: DC Zadanie 5 i 6
# ==========================================
fig2, ax4 = plt.subplots(figsize=(8, 6))
fig2.suptitle('DC Zadanie 5 i 6: Charakterystyki ze zwartą bramką ($U_{GS} = U_{DS}$)', fontsize=14, fontweight='bold')
...
# ==========================================
# Figura 3: AC Zadanie 1
# ==========================================
fig3, (ax5, ax6) = plt.subplots(1, 2, figsize=(14, 6))
fig3.suptitle('AC Zadanie 1: Parametry małosygnałowe w funkcji $U_{DS}$ i $U_{GS}$', fontsize=14, fontweight='bold')
...
# ==========================================
# Figura 4: AC Zadanie 2
# ==========================================
fig4, (ax7, ax8) = plt.subplots(1, 2, figsize=(14, 6))
fig4.suptitle('AC Zadanie 2: Tranzystor PMOS w funkcji temperatury', fontsize=14, fontweight='bold')
